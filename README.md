...
- На YouTube — получение готовой китайской дорожки `zh-Hans`, включая автоматическую, если она доступна. Пиньинь выводится над иероглифами; перевод китайской реплики содержит краткий словарь `пиньинь — русский`.
