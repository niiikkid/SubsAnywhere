...
- Системное произношение китайских и английских слов и фраз в субтитрах, таблице и режиме повторения; выбранная скорость сохраняется общей для всех экранов.
