...
6. В **«Внешнем виде»** включите **«Переводы над фразами»**: готовый словарь показывается прямо в субтитрах ячейками, русский перевод — мелко сверху, английский или пиньинь — основным текстом. Пары равномерно распределяются по строкам; длинный перевод переносится внутри своей ячейки, иероглифы остаются снизу. Фон подстраивается под текст и полностью исчезает в паузах. Субтитры и полный перевод удерживаются внутри плеера, в том числе после изменения его размера; сохранённая позиция при этом не меняется. Если экстремально длинная реплика не помещается даже по высоте, её можно прокрутить — текст не обрезается и не уменьшается до нечитаемого размера. Клик по ячейке открывает полный перевод. Режим сохраняется для страницы и не делает дополнительных AI-запросов. Пока перевод готовится или словарь пуст, остаётся обычная строка; для фраз, отсутствующих в словаре, перевод не придумывается.
