...
- На YouTube автоматически скачивает готовые китайские субтитры через локальный сервер и подключает их как SRT.
...
2. Расширение сохранит её локально как SRT и подключит к текущей странице.
